...
public enum TelecomFrequency {
    // 2G
    G2_900("2G", "900 MHz", "-", 900, 1, 0.0025f),
    G2_1800("2G", "1800 MHz", "-", 1800, 1, 0.005f),

    // 3G
    G3_900("3G", "900 MHz", "-", 900, 10, 0.0025f),
    G3_2100("3G", "2100 MHz", "-", 2100, 20, 0.006f),

    // 4G
    G4_700("4G", "700 MHz", "Bande 28", 700, 75, 0.0015f),
    G4_800("4G", "800 MHz", "Bande 20", 800, 75, 0.002f),
    G4_900("4G", "900 MHz", "Bande 8", 900, 50, 0.0025f),
    G4_1800("4G", "1800 MHz", "Bande 3", 1800, 150, 0.005f),
    G4_2100("4G", "2100 MHz", "Bande 1", 2100, 150, 0.006f),
    G4_2600("4G", "2600 MHz", "Bande 7", 2600, 200, 0.0075f),

    // 5G
    G5_700("5G", "700 MHz", "n28", 700, 150, 0.0015f),
    G5_2100("5G", "2100 MHz", "n1", 2100, 300, 0.006f),
    G5_3500("5G", "3.5 GHz", "n78", 3500, 1000, 0.015f),
    G5_26000("5G", "26 GHz", "n258", 26000, 5000, 0.125f);
