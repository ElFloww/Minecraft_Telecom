...
public class ServerScreen extends Screen {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Title
        guiGraphics.drawString(this.font, "Telecom Server - Datacenter Core", startX + 10, startY + 10, 0xFF00FF00);

        // Stats
        guiGraphics.drawString(this.font, "Connected Devices:", startX + 10, startY + 35, 0xFFAAAAAA);
        
        guiGraphics.drawString(this.font, "• Routers: " + payload.routerCount(), startX + 20, startY + 50, 0xFFFFFFFF);
        guiGraphics.drawString(this.font, "• Antennas: " + payload.antennaCount(), startX + 20, startY + 65, 0xFFFFFFFF);
        guiGraphics.drawString(this.font, "• Mobile Phones: " + payload.phoneCount(), startX + 20, startY + 80, 0xFFFFFFFF);

        int totalDevices = payload.routerCount() + payload.antennaCount() + payload.phoneCount();
        guiGraphics.drawString(this.font, "Total Endpoints: " + totalDevices, startX + 10, startY + 100, 0xFF00FFFF);

        // Bandwidth
        int maxCapacity = 100000; // 100 Gbps
        guiGraphics.drawString(this.font, "Core Load:", startX + 10, startY + 120, 0xFFFFAA00);
        guiGraphics.drawString(this.font, "Down: " + totalDown + " Mbps / " + maxCapacity + " Mbps", startX + 20, startY + 133, 0xFF00FFFF);
        guiGraphics.drawString(this.font, "Up: " + totalUp + " Mbps / " + maxCapacity + " Mbps", startX + 20, startY + 146, 0xFFFF8800);
        
        int percent = (int)(((float)(totalDown + totalUp) / maxCapacity) * 100);
        guiGraphics.drawString(this.font, "Network Usage: " + percent + "%", startX + 10, startY + 160, percent > 80 ? 0xFFFF0000 : 0xFF00FF00);
