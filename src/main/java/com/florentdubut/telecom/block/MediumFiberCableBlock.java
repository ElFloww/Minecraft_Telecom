...
public class MediumFiberCableBlock extends CableBlock {
    // 6.0 to 10.0 is 4 pixels thick. Let's make it 6 pixels thick (5.0 to 11.0)
    ...
    public MediumFiberCableBlock(Properties properties) {
        super(properties);
    }
